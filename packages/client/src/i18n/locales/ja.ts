export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '次回再起動時にローカルサービスの起動前に現在の Runtime とダウンロード済み Web UI をコピーして検証します。元の保存先は保持され、今後のダウンロードもここに保存されます。',
  ...
  appRelay: {
    title: 'APP',
    sidebarDescription: '独立した APP 接続とペアリングコードを管理します。',
    status: '接続状態',
    connected: '接続済み',
    disconnected: '未接続',
    machineId: 'マシン ID',
    pairingTitle: 'デバイスのペアリング',
    pairingDescription: 'APP にこのコードを入力して、アカウントをこのマシンに紐付けます。',
    noPairingCode: '有効なペアリングコードがありません',
    expiresIn: '有効期限まで {minutes}:{seconds}',
    expired: 'ペアリングコードの有効期限が切れました',
    connect: 'APP を接続',
    refreshPairing: 'コードを更新',
    disconnect: '切断',
    disconnectConfirm: '独立した APP チャンネルを切断しますか？',
    refreshStatus: '状態を更新',
    copied: 'ペアリングコードをコピーしました',
    copyFailed: 'ペアリングコードをコピーできませんでした',
    connectedMessage: 'APP チャンネルに接続しました',
    disconnectedMessage: 'APP チャンネルを切断しました',
    pairingRefreshed: 'ペアリングコードを更新しました',
    loadFailed: 'APP の状態を読み込めませんでした',
    connectFailed: 'APP チャンネルに接続できませんでした',
    pairingFailed: 'ペアリングコードを更新できませんでした',
    disconnectFailed: 'APP チャンネルを切断できませんでした',
    independentTitle: '独立チャンネル',
    independentDescription: 'APP Relay は独自の接続、ペアリング、権限を使用し、MCU チャンネルを開始または切断しません。',
    localAuth: '転送されたリクエストには、引き続きローカル Hermes ユーザーの権限が必要です。',
    loggedInAs: 'ログイン中',
    logout: 'ログアウト',
    accountTitle: 'APP アカウント',
    register: '登録',
    login: 'ログイン',
    accountDescription: 'このマシンを接続する前に、モバイル APP アカウントを登録またはログインしてください。',
    email: 'メールアドレス',
    ...
    verificationCodeFailed: '認証コードを送信できませんでした',
    verificationCodeRequired: '6 桁の認証コードを入力してください',
    emailVerificationUnavailable: 'サーバーに送信メールが設定されていません。',
    password: 'パスワード',
    passwordPlaceholder: 'パスワードを入力',
    passwordHint: '8 文字以上で入力してください。',
    createAccount: 'アカウントを作成',
    authUnavailable: 'APP アカウントサービスを利用できません',
    authRequired: 'メールアドレスとパスワードを入力してください',
    ...
    authErrors: {
      ...
      verification_code_required: '6 桁の認証コードを入力してください',
      invalid_or_expired_verification_code: '認証コードが正しくないか期限切れです',
      verification_attempts_exceeded: '試行回数が多すぎます。新しいコードを取得してください。',
      verification_code_too_frequent: 'しばらく待ってから再送してください',
      email_delivery_not_configured: 'サーバーに送信メールが設定されていません',
      email_delivery_failed: '認証メールを送信できませんでした',
      rate_limited: '試行回数が多すぎます。後でもう一度お試しください。',
      account_disabled: 'このアカウントは無効です',
      invalid_refresh_token: 'セッションの期限が切れました。再度ログインしてください。',
      unauthorized: 'セッションの期限が切れました。再度ログインしてください。',
      app_user_not_found: 'APP アカウントが見つかりません',
      internal_error: 'APP アカウントサービスでエラーが発生しました',
      app_auth_failed: 'APP アカウントのリクエストに失敗しました',
      invalid_app_auth_url: 'APP アカウントサービスのアドレスが無効です',
    },
  },
  ...
  changelog: {
    ...
    new_0_6_31_4: '管理者は revision 検査、認証情報の秘匿、ドラフト接続テスト、優先モデル、コンテキスト長、監査履歴を使って Provider を安全に編集できます（#2114）',
    new_0_6_31_5: '単一チャットとグループチャットがメッセージ参照に対応し、バックグラウンド delegate task は親ターン終了後や再起動後も子 Agent の出力を確実に配信します（#2098、#2126）',
    new_0_6_31_6: '履歴の読み込みとページングが安定し、セッションの Profile フィルターが保持され、workspace diff はライブ時も再読み込み後も正しいアシスタント応答に紐付きます（#2107、#2123、#2127）',
    new_0_6_31_7: 'モデル切り替え時にドラフト workspace を保持し、reasoning effort は各モデルの対応範囲を分かりやすいスライダーで選べるようになりました（#2095、#2097）',
    new_0_6_31_8: 'Desktop 更新はダウンロード前に確認し、「今すぐ再起動」はインストーラー起動前にトレイ終了と同じ正常なサービス停止処理を行います（#2094、#2125）',
    new_0_6_31_9: 'グループチャット、Coding Agent、Desktop カードのダーク表示を統一し、macOS のマイク権限、トレイサイズ、Liquid Glass 対応アイコンも改善しました（#2087、#2092、#2100、#2101、#2108、#2130）',
    new_0_6_31_10: 'スケジュールジョブの有効な配信先選択が安定し、チャンネル設定から保存済み認証情報を安全に消去して Gateway 再起動結果を確認できます（#2106、#2109）',
    new_0_6_31_11: 'Studio MCP の自動注入は、明示的に許可されない限り一時ディレクトリや linked worktree の launcher を除外し、不安定なパスの永続化を防ぎます（#2121）',
    new_0_6_31_12: 'バージョン管理で Runtime の保存先を移行またはシステム既定に戻せます。再起動時に Runtime と Web UI をコピー・検証し、元の保存先も保持します（#2134）',
    ...
    new_0_6_30_3: '有効な MoA プリセットを Hermes チャットセッションの作成時と切り替え時に選択でき、名称、既定値、コンテキスト長、実行時動作も正しく反映されます（#2078）',
    new_0_6_30_4: 'Markdown、Mermaid、Monaco、未使用の言語、任意のオーバーレイを遅延読み込みし、初回画面の JavaScript 読み込み量を大幅に削減しました（#2068）',
    new_0_6_30_5: '個別チャットに、ライブ文字起こし、音声のキュー再生、ツール活動、割り込み操作を備えた全画面リアルタイム音声モードを追加しました（#2063）',
    new_0_6_30_6: 'デスクトップとモバイルのリアルタイム音声が安定し、無音から復帰し、アシスタント音声の録音を避け、現在の STT フォールバックを使用しながら承認画面を表示し続けます（#2064、#2067）',
    new_0_6_30_7: 'Ekko Agent にスコープ付き永続メモリを追加し、現在の Provider とモデルを実行コンテキストに含め、本番環境のメモリ DB もより安全に扱います（#2057、#2060、#2071）',
    new_0_6_30_8: 'Provider 未設定の Profile には、Provider フォームを直接開ける設定案内が表示されるようになりました（#2070）',
    new_0_6_30_9: 'Provider のモデルカタログを Hermes Agent と揃え、古いフォールバックキャッシュで更新を隠さず、ライブ検出を優先します（#2051）',
    new_0_6_30_10: '読み込み済みチャット内でカスタム Provider のエイリアスを安定して保持し、不要なクライアント再構築とリクエストヘッダー消失を防ぎます（#2054）',
    new_0_6_30_11: 'セッションのモデル切り替え中はブロック型の進行状態を表示し、会話切り替え時は下書きや添付を再マウントせずフェードを再生します（#2056、#2069）',
    new_0_6_30_12: 'Journey グラフにカテゴリの複数選択、Skill と Memory の専用形状、プレビュー、改善されたキーボードとタッチ操作を追加しました（#2055）',
    new_0_6_30_13: 'Markdown ダウンロードで拡張子を保持し、モバイル文字起こしに明示的な開始・停止操作を追加し、Scoped Codex のストリーミングで最終応答が重複しないようにしました（#2058、#2066）',
    new_0_6_30_14: 'MCU はデバイスコード表示、マイク自動選択、切断状態の同期、時間制限付き TLS 検出により、設定と信頼性が向上しました（#2049、#2059、#2062）',
    new_0_6_30_15: 'Windows のチャットで Git または通常のディレクトリの workspace 変更を取得する際、Git コンソールウィンドウが点滅しなくなりました（#2080）',
    new_0_6_29_1: '本リリースは 0.6.28 以降にマージされた 14 件の PR を収録し、UI 統一、MCU 音声と v2 ハードウェア、workspace diff、使用量分析、Docker 更新、MiMo 音声クローンを含みます',
    new_0_6_29_2: 'ページヘッダー、ダークサーフェス、角丸を共通のビジュアルシステムに統一し、バージョンプレビューは有効なタグをセマンティックバージョン順に表示します（#2014、#2015）',
    new_0_6_29_3: 'ESP32 製品ページをレスポンシブに刷新し、Web サイトのバージョン選択に Hermes Agent 0.18.2 を追加しました（#2020、#2042）',
    new_0_6_29_4: 'ESP32-C3 v1 の上り音声を IMA-ADPCM 化して帯域を約 4 分の 1 に削減し、録音上限を 2 分に延長しました。OLED は一時状態後に LAN IP 表示へ戻ります（#2024、#2025）',
    new_0_6_29_5: 'Workspace diff は既定で折りたたまれ、0 行の変更を除外します。チャット入力欄の標準ダーク背景も復元しました（#2032）',
    new_0_6_29_6: 'セッション書き出しは不正なパーセント記号を含むファイル名に対応し、Docker 更新はコンテナ内 npm を変更せず pull/recreate 手順を表示します（#2026、#2033）',
    new_0_6_29_7: 'Bridge ツール結果は完全保存したまま、モデルコンテキストでは先頭・末尾を使った 5,500 文字の要約に制限します（#2036）',
    new_0_6_29_8: 'Hermes Agent、Claude Code、Codex、Ekko Agent のモデル呼び出しを統合して記録し、Agent 分布ビューを追加しました（#2039）',
    new_0_6_29_9: '独立した ESP32-C3 v2 ファームウェアに新しいピン構成を追加し、v1 への影響を分離しました。v2 は既定 80%、1.5 倍 PCM ゲインとソフトリミットを使用します（#2044、#2045）',
    new_0_6_29_10: 'MiMo 音声クローンで WAV/MP3 参照音声のアップロードを復元し、現行 API が要求する audio.voice で送信します（#2046）',
