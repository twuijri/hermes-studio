export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '下次重新啟動時會在本機服務啟動前複製並驗證目前 Runtime 和已下載的 Web UI 版本，舊目錄會保留；後續下載也會儲存在這裡。',
  ...
  appRelay: {
    title: 'APP',
    sidebarDescription: '管理獨立的行動 APP 連線與裝置配對碼。',
    status: '連線狀態',
    connected: '已連線',
    disconnected: '未連線',
    machineId: '機器 ID',
    pairingTitle: '裝置配對',
    pairingDescription: '在 APP 中輸入此配對碼，將你的帳號綁定到這台機器。',
    noPairingCode: '目前沒有有效配對碼',
    expiresIn: '{minutes}:{seconds} 後到期',
    expired: '配對碼已到期',
    connect: '連線 APP',
    refreshPairing: '重新產生配對碼',
    disconnect: '中斷連線',
    disconnectConfirm: '確定中斷獨立 APP 通道？',
    refreshStatus: '重新整理狀態',
    copied: '已複製配對碼',
    copyFailed: '無法複製配對碼',
    connectedMessage: 'APP 通道已連線',
    disconnectedMessage: 'APP 通道已中斷',
    pairingRefreshed: '配對碼已更新',
    loadFailed: '載入 APP 狀態失敗',
    connectFailed: 'APP 通道連線失敗',
    pairingFailed: '更新配對碼失敗',
    disconnectFailed: '中斷 APP 通道失敗',
    independentTitle: '獨立通道',
    independentDescription: 'APP Relay 使用獨立的連線、配對與權限，不會啟動或中斷 MCU 通道。',
    localAuth: '轉送的請求仍須通過本機 Hermes 使用者權限驗證。',
    loggedInAs: '目前帳號',
    logout: '登出',
    accountTitle: 'APP 帳號',
    register: '註冊',
    login: '登入',
    accountDescription: '連線這台機器前，請先註冊或登入行動 APP 帳號。',
    email: '電子郵件',
    ...
    verificationCodePlaceholder: '6 位驗證碼',
    sendVerificationCode: '傳送驗證碼',
    resendIn: '{seconds} 秒後重傳',
    verificationCodeSent: '驗證碼已傳送',
    verificationCodeFailed: '驗證碼傳送失敗',
    verificationCodeRequired: '請輸入 6 位電子郵件驗證碼',
    emailVerificationUnavailable: '伺服器尚未設定寄件信箱。',
    password: '密碼',
    passwordPlaceholder: '請輸入密碼',
    passwordHint: '密碼至少需要 8 個字元。',
    createAccount: '建立帳號',
    authUnavailable: 'APP 帳號服務暫時無法使用',
    authRequired: '請輸入電子郵件與密碼',
    ...
    authErrors: {
      ...
      verification_code_required: '請輸入 6 位電子郵件驗證碼',
      invalid_or_expired_verification_code: '驗證碼錯誤或已過期',
      verification_attempts_exceeded: '錯誤次數過多，請重新取得驗證碼',
      verification_code_too_frequent: '請稍候再要求新的驗證碼',
      email_delivery_not_configured: '伺服器尚未設定寄件信箱',
      email_delivery_failed: '驗證碼郵件傳送失敗',
      rate_limited: '嘗試次數過多，請稍後再試',
      account_disabled: '此帳號已停用',
      invalid_refresh_token: '登入已過期，請重新登入',
      unauthorized: '登入已過期，請重新登入',
      app_user_not_found: '找不到 APP 帳號',
      internal_error: 'APP 帳號服務發生錯誤',
      app_auth_failed: 'APP 帳號請求失敗',
      invalid_app_auth_url: 'APP 帳號服務地址無效',
    },
  },
  ...
  changelog: {
    ...
    new_0_6_31_4: '管理員可透過 revision 檢查、憑證遮蔽、草稿連線測試、偏好模型、上下文長度和稽核記錄安全編輯 Provider（#2114）',
    new_0_6_31_5: '單聊和群聊支援訊息引用；背景 delegate task 在父回合結束或應用程式重新啟動後仍能可靠傳送子 Agent 輸出（#2098、#2126）',
    new_0_6_31_6: '歷史工作階段載入和分頁更可靠，Profile 篩選會持久保存，workspace diff 在即時和重新載入的聊天中都會歸屬到正確的助理回覆（#2107、#2123、#2127）',
    new_0_6_31_7: '切換模型會保留草稿 workspace，reasoning effort 也改為涵蓋模型支援範圍的清楚滑桿（#2095、#2097）',
    new_0_6_31_8: '桌面更新現在需要先確認下載；「立即重新啟動」會在啟動安裝程式前執行與系統匣結束相同的服務優雅關閉流程（#2094、#2125）',
    new_0_6_31_9: '群聊、Coding Agent 和桌面卡片統一深色介面；macOS 同時修正麥克風權限和系統匣尺寸，並支援 Liquid Glass 圖示（#2087、#2092、#2100、#2101、#2108、#2130）',
    new_0_6_31_10: '排程任務能更可靠地選擇有效傳送目標，頻道設定也可安全清除已儲存憑證，並明確回報 Gateway 重新啟動結果（#2106、#2109）',
    new_0_6_31_11: 'Studio MCP 自動注入預設略過暫存目錄和 linked worktree 中的 launcher，除非明確允許，避免把不穩定路徑寫入持久 Profile 設定（#2121）',
    new_0_6_31_12: '版本管理現在可以遷移 Runtime 儲存目錄或恢復系統預設；下次重新啟動時會複製驗證 Runtime 和已下載的 Web UI 版本，並保留舊副本（#2134）',
    new_0_6_30_1: '本版本彙整 0.6.29 之後合併的 21 個 PR，涵蓋工作流程編排、MoA 會話、即時語音、持久記憶、Provider 穩定性、MCU 設定和 Windows 體驗最佳化',
    new_0_6_30_2: '工作流程編排 v2 新增依成功、失敗和一律執行的條件路由、真正略過、all/any 匯合、有界回饋迴圈、執行證據、截止時間與可攜式匯入（#2073）',
    new_0_6_30_3: '已啟用的 MoA 組合現在可在建立或切換 Hermes 聊天會話時選擇，並正確處理組合名稱、預設項、上下文視窗與執行階段行為（#2078）',
    new_0_6_30_4: '首屏透過按需載入 Markdown、Mermaid、Monaco、非目前語言和選用浮層，大幅減少初始 JavaScript（#2068）',
    new_0_6_30_5: '單聊新增全螢幕即時語音模式，支援即時轉寫、語音佇列播放、工具活動和打斷控制（#2063）',
    new_0_6_30_6: '桌面端與行動端即時語音更加穩定，可從靜默恢復、避免錄入助手語音、使用目前 STT 備援服務，並保持審批彈窗可見（#2064、#2067）',
    new_0_6_30_7: 'Ekko Agent 新增持久化的作用域記憶，在執行階段上下文中提供目前 Provider 和模型，並更安全地處理正式環境記憶資料庫（#2057、#2060、#2071）',
    new_0_6_30_8: '未設定 Provider 的 Profile 現在會顯示設定引導，並可直接開啟 Provider 表單（#2070）',
    new_0_6_30_9: 'Provider 模型目錄已與 Hermes Agent 對齊，即時探索結果優先，過期備援快取不再遮蔽更新（#2051）',
    new_0_6_30_10: '自訂 Provider 別名在已載入的聊天會話中保持穩定，避免不必要的客戶端重建和請求標頭遺失（#2054）',
    new_0_6_30_11: '會話模型切換現在顯示阻塞式進度狀態，切換對話時也會重播淡入動畫且不重建草稿或附件（#2056、#2069）',
    new_0_6_30_12: 'Journey 圖譜新增類別多選、不同的 Skill 和 Memory 節點形狀、預覽，以及更完善的鍵盤和觸控操作（#2055）',
    new_0_6_30_13: 'Markdown 下載會保留副檔名，行動端轉寫新增明確的開始和停止控制，Scoped Codex 串流輸出也不再重複最終助手訊息（#2058、#2066）',
    new_0_6_30_14: 'MCU 設定與穩定性改進：顯示裝置碼、自動選擇麥克風、同步斷線狀態並限制 TLS 探測時間（#2049、#2059、#2062）',
    new_0_6_30_15: 'Windows 對話在 Git 或一般目錄中擷取工作區變更時不再閃現 Git 黑窗（#2080）',
    new_0_6_29_1: '本版本彙整 0.6.28 之後合併的 14 個 PR，涵蓋介面統一、MCU 音訊與 v2 硬體、workspace diff、模型用量統計、Docker 更新和 MiMo 音色複製',
    new_0_6_29_2: '統一頁面標題、深色卡片和圓角等視覺規範；版本預覽會依語意版本倒序顯示有效標籤（#2014、#2015）',
    new_0_6_29_3: 'ESP32 產品介紹頁完成響應式改版，網站版本選擇器新增 Hermes Agent 0.18.2（#2020、#2042）',
    new_0_6_29_4: 'ESP32-C3 v1 上行語音改用 IMA-ADPCM，頻寬降至約四分之一、錄音上限增至 2 分鐘；OLED 狀態結束後會恢復顯示區域網路 IP（#2024、#2025）',
    new_0_6_29_5: 'Workspace diff 預設摺疊並過濾零行變更，同時恢復聊天輸入框的標準深色背景（#2032）',
    new_0_6_29_6: '會話匯出可相容含異常百分號的檔名；Docker 使用者點擊升級時會看到映像拉取與重建指引，而不會修改容器內 npm（#2026、#2033）',
    new_0_6_29_7: 'Bridge 工具結果仍會完整儲存，但進入模型上下文時限制為 5,500 字元的頭尾摘要，避免大型結果持續放大上下文（#2036）',
    new_0_6_29_8: '用量分析統一記錄 Hermes Agent、Claude Code、Codex 和 Ekko Agent 的模型呼叫，並新增 Agent 分布檢視（#2039）',
    new_0_6_29_9: '新增獨立的 ESP32-C3 v2 韌體與硬體腳位設定，保持 v1 隔離；v2 預設音量 80%，採用 1.5 倍 PCM 增益和軟限制提升響度（#2044、#2045）',
    new_0_6_29_10: 'MiMo 音色複製恢復 WAV/MP3 參考音訊上傳，並依目前 API 要求透過 audio.voice 傳送參考音訊（#2046）',
