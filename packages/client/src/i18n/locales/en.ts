export default {
  ...
  appRelay: {
    title: 'APP',
    sidebarDescription: 'Manage the independent mobile APP connection and pairing code.',
    status: 'Connection status',
    connected: 'Connected',
    disconnected: 'Disconnected',
    machineId: 'Machine ID',
    pairingTitle: 'Device pairing',
    pairingDescription: 'Enter this code in the APP to bind your account to this machine.',
    noPairingCode: 'No active pairing code',
    expiresIn: 'Expires in {minutes}:{seconds}',
    expired: 'The pairing code has expired',
    connect: 'Connect APP',
    refreshPairing: 'Refresh pairing code',
    disconnect: 'Disconnect',
    disconnectConfirm: 'Disconnect the independent APP channel?',
    refreshStatus: 'Refresh status',
    copied: 'Pairing code copied',
    copyFailed: 'Could not copy the pairing code',
    connectedMessage: 'APP channel connected',
    disconnectedMessage: 'APP channel disconnected',
    pairingRefreshed: 'Pairing code refreshed',
    loadFailed: 'Failed to load APP status',
    connectFailed: 'Failed to connect the APP channel',
    pairingFailed: 'Failed to refresh the pairing code',
    disconnectFailed: 'Failed to disconnect the APP channel',
    independentTitle: 'Independent channel',
    independentDescription: 'APP Relay has its own connection, pairing, and permissions. It never starts or disconnects the MCU channel.',
    localAuth: 'Forwarded requests still require normal local Hermes user authorization.',
    loggedInAs: 'Signed in as',
    logout: 'Sign out',
    accountTitle: 'APP account',
    register: 'Register',
    login: 'Sign in',
    accountDescription: 'Register or sign in before connecting this machine to the mobile APP.',
    email: 'Email',
    ...
    verificationCodeRequired: 'Enter the 6-digit verification code',
    emailVerificationUnavailable: 'Email delivery is not configured on the server yet.',
    password: 'Password',
    passwordPlaceholder: 'Enter your password',
    passwordHint: 'Use at least 8 characters.',
    createAccount: 'Create account',
    authUnavailable: 'The APP account service is unavailable',
    authRequired: 'Enter your email and password',
    ...
    authErrors: {
      ...
      invalid_or_expired_verification_code: 'The verification code is incorrect or expired',
      ...
      email_delivery_not_configured: 'Email delivery is not configured on the server',
      email_delivery_failed: 'The verification email could not be sent',
      rate_limited: 'Too many attempts. Please try again later.',
      account_disabled: 'This account has been disabled',
      invalid_refresh_token: 'Your session has expired. Please sign in again.',
      unauthorized: 'Your session has expired. Please sign in again.',
      app_user_not_found: 'APP account not found',
      internal_error: 'The APP account service encountered an error',
      app_auth_failed: 'APP account request failed',
      invalid_app_auth_url: 'The APP account service address is invalid',
    },
  },
