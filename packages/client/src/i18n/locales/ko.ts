export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '다음 재시작 시 로컬 서비스 시작 전에 현재 Runtime과 다운로드된 Web UI 버전을 복사하고 검증합니다. 이전 저장소는 유지되며 이후 다운로드도 여기에 저장됩니다.',
  ...
  appRelay: {
    title: 'APP',
    sidebarDescription: '독립적인 APP 연결과 페어링 코드를 관리합니다.',
    status: '연결 상태',
    connected: '연결됨',
    disconnected: '연결 안 됨',
    machineId: '기기 ID',
    pairingTitle: '기기 페어링',
    pairingDescription: 'APP에 이 코드를 입력하여 계정을 이 기기에 연결하세요.',
    noPairingCode: '활성 페어링 코드 없음',
    expiresIn: '{minutes}:{seconds} 후 만료',
    expired: '페어링 코드가 만료되었습니다',
    connect: 'APP 연결',
    refreshPairing: '페어링 코드 새로 고침',
    disconnect: '연결 해제',
    disconnectConfirm: '독립 APP 채널의 연결을 해제할까요?',
    refreshStatus: '상태 새로 고침',
    copied: '페어링 코드를 복사했습니다',
    copyFailed: '페어링 코드를 복사하지 못했습니다',
    connectedMessage: 'APP 채널이 연결되었습니다',
    disconnectedMessage: 'APP 채널 연결이 해제되었습니다',
    pairingRefreshed: '페어링 코드를 새로 고쳤습니다',
    loadFailed: 'APP 상태를 불러오지 못했습니다',
    connectFailed: 'APP 채널을 연결하지 못했습니다',
    pairingFailed: '페어링 코드를 새로 고치지 못했습니다',
    disconnectFailed: 'APP 채널 연결을 해제하지 못했습니다',
    independentTitle: '독립 채널',
    independentDescription: 'APP Relay는 별도의 연결, 페어링 및 권한을 사용하며 MCU 채널을 시작하거나 끊지 않습니다.',
    localAuth: '전달된 요청에는 로컬 Hermes 사용자 권한이 계속 필요합니다.',
    loggedInAs: '로그인 계정',
    logout: '로그아웃',
    accountTitle: 'APP 계정',
    register: '가입',
    login: '로그인',
    accountDescription: '이 기기를 연결하기 전에 모바일 APP 계정에 가입하거나 로그인하세요.',
    email: '이메일',
    ...
    verificationCodeSent: '인증 코드를 보냈습니다',
    verificationCodeFailed: '인증 코드를 보내지 못했습니다',
    verificationCodeRequired: '6자리 인증 코드를 입력하세요',
    emailVerificationUnavailable: '서버에 발신 이메일이 설정되지 않았습니다.',
    password: '비밀번호',
    passwordPlaceholder: '비밀번호 입력',
    passwordHint: '8자 이상 입력하세요.',
    createAccount: '계정 만들기',
    authUnavailable: 'APP 계정 서비스를 사용할 수 없습니다',
    authRequired: '이메일과 비밀번호를 입력하세요',
    registerSuccess: '계정을 만들었습니다',
    ...
    authErrors: {
      ...
      invalid_password: '비밀번호가 요구 사항을 충족하지 않습니다',
      verification_code_required: '6자리 인증 코드를 입력하세요',
      invalid_or_expired_verification_code: '인증 코드가 잘못되었거나 만료되었습니다',
      verification_attempts_exceeded: '시도 횟수가 너무 많습니다. 새 코드를 요청하세요.',
      verification_code_too_frequent: '잠시 후 새 코드를 요청하세요',
      email_delivery_not_configured: '서버에 발신 이메일이 설정되지 않았습니다',
      email_delivery_failed: '인증 이메일을 보내지 못했습니다',
      rate_limited: '시도 횟수가 너무 많습니다. 나중에 다시 시도하세요.',
      account_disabled: '비활성화된 계정입니다',
      invalid_refresh_token: '세션이 만료되었습니다. 다시 로그인하세요.',
      unauthorized: '세션이 만료되었습니다. 다시 로그인하세요.',
      app_user_not_found: 'APP 계정을 찾을 수 없습니다',
      internal_error: 'APP 계정 서비스에 오류가 발생했습니다',
      app_auth_failed: 'APP 계정 요청에 실패했습니다',
      invalid_app_auth_url: 'APP 계정 서비스 주소가 올바르지 않습니다',
    },
  },
  ...
  changelog: {
    ...
    new_0_6_31_4: '관리자는 revision 검사, 자격 증명 마스킹, 초안 연결 테스트, 선호 모델, 컨텍스트 길이, 감사 기록을 통해 Provider를 안전하게 편집할 수 있습니다 (#2114)',
    new_0_6_31_5: '일반 채팅과 그룹 채팅에서 메시지를 참조할 수 있으며, 백그라운드 delegate task는 부모 턴 종료나 앱 재시작 후에도 하위 Agent 출력을 안정적으로 전달합니다 (#2098, #2126)',
    new_0_6_31_6: '기록 로딩과 페이지네이션이 안정화되고 세션 Profile 필터가 유지되며, workspace diff가 실시간 및 재로드된 채팅에서 정확한 어시스턴트 응답에 연결됩니다 (#2107, #2123, #2127)',
    new_0_6_31_7: '모델 전환 시 초안 workspace가 유지되고 reasoning effort를 각 모델의 지원 범위에 맞는 명확한 슬라이더로 선택할 수 있습니다 (#2095, #2097)',
    new_0_6_31_8: 'Desktop 업데이트는 다운로드 전에 확인하며, \'지금 다시 시작\'은 설치 프로그램 실행 전에 트레이 종료와 같은 정상 서비스 종료 절차를 수행합니다 (#2094, #2125)',
    new_0_6_31_9: '그룹 채팅, Coding Agent, Desktop 카드의 어두운 화면이 통일되었고 macOS 마이크 권한, 트레이 크기, Liquid Glass 아이콘도 개선되었습니다 (#2087, #2092, #2100, #2101, #2108, #2130)',
    new_0_6_31_10: '예약 작업의 유효한 전달 대상 선택이 안정화되고 채널 설정에서 저장된 자격 증명을 안전하게 지우며 Gateway 재시작 결과를 확인할 수 있습니다 (#2106, #2109)',
    new_0_6_31_11: 'Studio MCP 자동 주입은 명시적으로 허용하지 않는 한 임시 디렉터리와 linked worktree launcher를 건너뛰어 불안정한 경로가 Profile 설정에 저장되지 않게 합니다 (#2121)',
    new_0_6_31_12: '버전 관리에서 Runtime 저장 위치를 옮기거나 시스템 기본값으로 복원할 수 있습니다. 재시작 시 Runtime과 Web UI를 복사·검증하고 이전 저장소를 유지합니다 (#2134)',
    ...
    new_0_6_30_3: '활성화된 MoA 프리셋을 Hermes 채팅 세션 생성 및 전환 시 선택할 수 있으며 이름, 기본값, 컨텍스트 창, 런타임 동작이 올바르게 적용됩니다 (#2078)',
    new_0_6_30_4: 'Markdown, Mermaid, Monaco, 비활성 언어, 선택형 오버레이를 지연 로드해 첫 화면의 JavaScript 로드량을 크게 줄였습니다 (#2068)',
    new_0_6_30_5: '개별 채팅에 실시간 전사, 음성 대기열 재생, 도구 활동, 중단 제어를 제공하는 전체 화면 실시간 음성 모드를 추가했습니다 (#2063)',
    new_0_6_30_6: '데스크톱과 모바일 실시간 음성이 더 안정적으로 동작하고, 무음 상태에서 복구하며, 어시스턴트 음성 녹음을 피하고, 활성 STT fallback을 사용하면서 승인을 계속 표시합니다 (#2064, #2067)',
    new_0_6_30_7: 'Ekko Agent에 범위가 지정된 영구 메모리를 추가하고 활성 Provider와 모델을 런타임 컨텍스트에 포함하며 운영 메모리 DB를 더 안전하게 처리합니다 (#2057, #2060, #2071)',
    new_0_6_30_8: 'Provider가 설정되지 않은 Profile에 Provider 설정 양식을 바로 여는 안내가 표시됩니다 (#2070)',
    new_0_6_30_9: 'Provider 모델 카탈로그를 Hermes Agent와 맞추고 오래된 fallback 캐시가 업데이트를 가리지 않도록 실시간 탐색 결과를 우선합니다 (#2051)',
    new_0_6_30_10: '로드된 채팅 전반에서 사용자 지정 Provider 별칭을 안정적으로 유지해 불필요한 클라이언트 재구성과 요청 헤더 손실을 방지합니다 (#2054)',
    new_0_6_30_11: '세션 모델 전환 중 차단형 진행 상태를 표시하고, 대화 전환 시 초안이나 첨부 파일을 다시 마운트하지 않고 페이드 효과를 재생합니다 (#2056, #2069)',
    new_0_6_30_12: 'Journey 그래프 탐색에 카테고리 다중 선택, Skill과 Memory 전용 모양, 미리보기, 향상된 키보드 및 터치 제어를 추가했습니다 (#2055)',
    new_0_6_30_13: 'Markdown 다운로드가 확장자를 유지하고, 모바일 전사에 명시적인 시작 및 중지 제어를 추가하며, Scoped Codex 스트리밍에서 최종 응답이 더 이상 중복되지 않습니다 (#2058, #2066)',
    new_0_6_30_14: 'MCU 설정과 안정성이 장치 코드 표시, 자동 마이크 선택, 연결 해제 동기화, 시간 제한 TLS 탐색으로 개선되었습니다 (#2049, #2059, #2062)',
    new_0_6_30_15: 'Windows 채팅에서 Git 또는 일반 디렉터리의 workspace 변경을 캡처할 때 Git 콘솔 창이 더 이상 깜박이지 않습니다 (#2080)',
    ...
    new_0_6_27_4: 'Remote MCU traffic은 Socket.IO /global-agent relay를 사용하며 ESP32-C3 로그인, 검색, 음성 재생 큐, Wi-Fi 자격 증명 저장, 업데이트된 firmware가 더 안정적으로 동작합니다',
    new_0_6_27_5: '그룹 채팅 room은 검증된 workspace를 보유하고 group-agent run에 전달할 수 있으며, 읽기 전용 멤버에게는 workspace, invite code, 관리 컨트롤이 숨겨집니다',
    new_0_6_27_6: '기본 workspace 즐겨찾기는 folder picker의 선택된 path 행 안으로 이동했으며 workspace picker label의 locale coverage도 완료했습니다',
    new_0_6_27_7: 'Workspace diff 카드는 patch나 줄 변화가 없는 0 byte change를 건너뛰어 의미 없는 +0/-0 changed-file 카드를 피합니다',
  },
}
