...
jobTriggered: 'Job ausgelost',
  ...
  profiles: {
    ...
    importTimeout: 'Zeitüberschreitung beim Import. Dieses Archiv ist zu groß, um es aus dem Browser zu entpacken — importieren Sie es stattdessen auf dem Server.',
