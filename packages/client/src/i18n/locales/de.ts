export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: 'Die aktuelle Runtime und heruntergeladene Web-UI-Versionen werden beim nächsten Neustart vor lokalen Diensten kopiert und geprüft. Der alte Speicher bleibt erhalten; künftige Downloads landen ebenfalls hier.',
...
jobTriggered: 'Job ausgelost',
  ...
  appRelay: {
    title: 'APP',
    sidebarDescription: 'Verwalte die unabhängige APP-Verbindung und den Kopplungscode.',
    status: 'Verbindungsstatus',
    connected: 'Verbunden',
    disconnected: 'Getrennt',
    machineId: 'Geräte-ID',
    pairingTitle: 'Gerät koppeln',
    pairingDescription: 'Gib diesen Code in der APP ein, um dein Konto mit diesem Gerät zu verbinden.',
    noPairingCode: 'Kein aktiver Kopplungscode',
    expiresIn: 'Läuft in {minutes}:{seconds} ab',
    expired: 'Der Kopplungscode ist abgelaufen',
    connect: 'APP verbinden',
    refreshPairing: 'Kopplungscode erneuern',
    disconnect: 'Trennen',
    disconnectConfirm: 'Den unabhängigen APP-Kanal trennen?',
    refreshStatus: 'Status aktualisieren',
    copied: 'Kopplungscode kopiert',
    copyFailed: 'Kopplungscode konnte nicht kopiert werden',
    connectedMessage: 'APP-Kanal verbunden',
    disconnectedMessage: 'APP-Kanal getrennt',
    pairingRefreshed: 'Kopplungscode erneuert',
    loadFailed: 'APP-Status konnte nicht geladen werden',
    connectFailed: 'APP-Kanal konnte nicht verbunden werden',
    pairingFailed: 'Kopplungscode konnte nicht erneuert werden',
    disconnectFailed: 'APP-Kanal konnte nicht getrennt werden',
    independentTitle: 'Unabhängiger Kanal',
    independentDescription: 'APP Relay hat eine eigene Verbindung, Kopplung und Berechtigung. Der MCU-Kanal wird weder gestartet noch getrennt.',
    localAuth: 'Weitergeleitete Anfragen benötigen weiterhin die lokale Hermes-Benutzerberechtigung.',
    loggedInAs: 'Angemeldet als',
    logout: 'Abmelden',
    accountTitle: 'APP-Konto',
    register: 'Registrieren',
    login: 'Anmelden',
    accountDescription: 'Registriere dich oder melde dich an, bevor du dieses Gerät mit der mobilen APP verbindest.',
    email: 'E-Mail',
    ...
    resendIn: 'Erneut in {seconds} s',
    verificationCodeSent: 'Bestätigungscode gesendet',
    verificationCodeFailed: 'Bestätigungscode konnte nicht gesendet werden',
    verificationCodeRequired: 'Gib den 6-stelligen Bestätigungscode ein',
    emailVerificationUnavailable: 'Der E-Mail-Versand ist auf dem Server noch nicht eingerichtet.',
    password: 'Passwort',
    passwordPlaceholder: 'Passwort eingeben',
    passwordHint: 'Verwende mindestens 8 Zeichen.',
    createAccount: 'Konto erstellen',
    authUnavailable: 'Der APP-Kontodienst ist nicht verfügbar',
    authRequired: 'Gib E-Mail und Passwort ein',
    ...
    authErrors: {
      ...
      invalid_password: 'Das Passwort erfüllt die Anforderungen nicht',
      verification_code_required: 'Gib den 6-stelligen Bestätigungscode ein',
      invalid_or_expired_verification_code: 'Der Code ist falsch oder abgelaufen',
      verification_attempts_exceeded: 'Zu viele Fehlversuche. Fordere einen neuen Code an.',
      verification_code_too_frequent: 'Warte, bevor du einen neuen Code anforderst',
      email_delivery_not_configured: 'Der E-Mail-Versand ist auf dem Server nicht eingerichtet',
      email_delivery_failed: 'Die Bestätigungs-E-Mail konnte nicht gesendet werden',
      rate_limited: 'Zu viele Versuche. Bitte später erneut versuchen.',
      account_disabled: 'Dieses Konto wurde deaktiviert',
      invalid_refresh_token: 'Deine Sitzung ist abgelaufen. Bitte erneut anmelden.',
      unauthorized: 'Deine Sitzung ist abgelaufen. Bitte erneut anmelden.',
      app_user_not_found: 'APP-Konto nicht gefunden',
      internal_error: 'Beim APP-Kontodienst ist ein Fehler aufgetreten',
      app_auth_failed: 'APP-Kontoanfrage fehlgeschlagen',
      invalid_app_auth_url: 'Die Adresse des APP-Kontodienstes ist ungültig',
    },
  },
  ...
  changelog: {
    ...
    new_0_6_31_1: 'Diese Version umfasst alle 25 nach 0.6.30 zusammengeführten PRs: Workflow-Routing und -Wiedergabe, Vorschauen erzeugter Dateien, Provider-Bearbeitung, erweiterte Chats sowie Desktop-Updates und visuelle Verbesserungen',
    new_0_6_31_2: 'Workflow ergänzt strukturierte JSON-Bedingungen, klarere Nachweise für blockierte Pfade, vollständige Detaildialoge für Ausführungsprotokolle und die Wiedergabe des tatsächlichen historischen Pfads (#2088, #2093, #2099, #2128)',
    new_0_6_31_3: 'Erzeugte HTML-, PDF-, DOCX-, PPTX-, XLSX-, CSV-, Bild-, Markdown- und Quelldateien lassen sich in Profile-Dateien, Session-Workspaces und verwalteten Gruppen-Workspaces sicher anzeigen (#2110, #2113)',
    new_0_6_31_4: 'Administratoren können Provider mit Revisionsprüfung, geschützten Zugangsdaten, Verbindungstest für Entwürfe, bevorzugten Modellen, Kontextlängen und Audit-Verlauf sicher bearbeiten (#2114)',
    new_0_6_31_5: 'Einzel- und Gruppenchats unterstützen Nachrichtenreferenzen; Hintergrund-delegate-tasks liefern Subagent-Ausgaben auch nach Ende des übergeordneten Turns oder einem Neustart dauerhaft aus (#2098, #2126)',
    new_0_6_31_6: 'Historienladen und Paginierung sind zuverlässiger, der Session-Profile-Filter bleibt erhalten und jeder workspace diff ist live wie nach dem Neuladen der richtigen Assistentenantwort zugeordnet (#2107, #2123, #2127)',
    new_0_6_31_7: 'Beim Modellwechsel bleibt der Entwurfs-Workspace erhalten und reasoning effort nutzt nun einen klaren Schieberegler über den unterstützten Bereich jedes Modells (#2095, #2097)',
    new_0_6_31_8: 'Desktop-Updates fragen vor dem Download nach; „Jetzt neu starten“ führt vor dem Installer denselben geordneten Dienststopp wie das Beenden über den Tray aus (#2094, #2125)',
    new_0_6_31_9: 'Gruppenchat, Coding Agents und Desktop-Karten nutzen einheitliche dunkle Flächen; macOS erhält außerdem korrigierte Mikrofonrechte, Tray-Größen und Liquid-Glass-fähige Symbole (#2087, #2092, #2100, #2101, #2108, #2130)',
    new_0_6_31_10: 'Geplante Jobs wählen gültige Zustellziele zuverlässiger und Kanaleinstellungen können gespeicherte Zugangsdaten sicher löschen und das Ergebnis des Gateway-Neustarts anzeigen (#2106, #2109)',
    new_0_6_31_11: 'Die Studio-MCP-Autoinjektion überspringt temporäre und linked-worktree-Launcher ohne ausdrückliche Freigabe, damit keine instabilen Pfade in der Profile-Konfiguration gespeichert werden (#2121)',
    new_0_6_31_12: 'Die Versionsverwaltung kann den Runtime-Speicher verlagern oder den Systemstandard wiederherstellen; beim Neustart werden Runtime und Web UI geprüft kopiert und der alte Speicher bleibt erhalten (#2134)',
