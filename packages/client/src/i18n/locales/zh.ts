export default {
  ...
  runtimeVersions: {
    ...
    runtimeDirectoryHint: '下次重启时会在本地服务启动前复制并校验当前 Runtime 和已下载的 Web UI 版本，旧目录会保留；后续下载也会保存在这里。',
  ...
  appRelay: {
    title: 'APP',
    sidebarDescription: '管理独立的移动 APP 连接和设备配对码。',
    status: '连接状态',
    connected: '已连接',
    disconnected: '未连接',
    machineId: '机器 ID',
    pairingTitle: '设备配对',
    pairingDescription: '在 APP 中输入此配对码，将你的账号绑定到这台机器。',
    noPairingCode: '暂无有效配对码',
    expiresIn: '{minutes}:{seconds} 后过期',
    expired: '配对码已过期',
    connect: '连接 APP',
    refreshPairing: '刷新配对码',
    disconnect: '断开连接',
    disconnectConfirm: '确定断开独立 APP 通道？',
    refreshStatus: '刷新状态',
    copied: '配对码已复制',
    copyFailed: '无法复制配对码',
    connectedMessage: 'APP 通道已连接',
    disconnectedMessage: 'APP 通道已断开',
    pairingRefreshed: '配对码已刷新',
    loadFailed: '加载 APP 状态失败',
    connectFailed: '连接 APP 通道失败',
    pairingFailed: '刷新配对码失败',
    disconnectFailed: '断开 APP 通道失败',
    independentTitle: '独立通道',
    independentDescription: 'APP Relay 使用独立的连接、配对和权限，不会启动或断开 MCU 通道。',
    localAuth: '转发的请求仍需通过本机 Hermes 用户权限校验。',
    loggedInAs: '当前账号',
    logout: '退出登录',
    accountTitle: 'APP 账号',
    register: '注册',
    login: '登录',
    accountDescription: '连接这台机器前，请先注册或登录移动 APP 账号。',
    email: '邮箱',
    ...
    verificationCodeRequired: '请输入 6 位邮箱验证码',
    emailVerificationUnavailable: '服务端尚未配置发件邮箱。',
    password: '密码',
    passwordPlaceholder: '请输入密码',
    passwordHint: '密码至少需要 8 个字符。',
    createAccount: '创建账号',
    authUnavailable: 'APP 账号服务暂不可用',
    authRequired: '请输入邮箱和密码',
    ...
    authErrors: {
      ...
      invalid_or_expired_verification_code: '验证码错误或已过期',
      verification_attempts_exceeded: '错误次数过多，请重新获取验证码',
      verification_code_too_frequent: '请求过于频繁，请稍后再试',
      email_delivery_not_configured: '服务端尚未配置发件邮箱',
      email_delivery_failed: '验证码邮件发送失败',
      rate_limited: '尝试次数过多，请稍后再试',
      account_disabled: '该账号已被禁用',
      invalid_refresh_token: '登录已过期，请重新登录',
      unauthorized: '登录已过期，请重新登录',
      app_user_not_found: '未找到 APP 账号',
      internal_error: 'APP 账号服务发生错误',
      app_auth_failed: 'APP 账号请求失败',
      invalid_app_auth_url: 'APP 账号服务地址无效',
    },
  },
  ...
  changelog: {
    ...
    new_0_6_31_4: '管理员可通过 revision 校验、凭证脱敏、草稿连接测试、首选模型、上下文长度和审计记录安全编辑 Provider（#2114）',
    new_0_6_31_5: '单聊和群聊支持消息引用；后台 delegate task 在父回合结束或应用重启后仍能可靠投递子 Agent 输出（#2098、#2126）',
    new_0_6_31_6: '历史会话加载和分页更可靠，Profile 筛选会持久保存，workspace diff 在实时和重载会话中都会归属到准确的助手回复（#2107、#2123、#2127）',
    new_0_6_31_7: '切换模型会保留草稿 workspace，reasoning effort 也改为覆盖模型支持范围的清晰滑块（#2095、#2097）',
    new_0_6_31_8: '桌面更新现在需要先确认下载；“立即重启”会在启动安装器前执行与托盘退出相同的服务优雅关闭流程（#2094、#2125）',
    new_0_6_31_9: '群聊、Coding Agent 和桌面卡片统一暗色界面；macOS 同时修复麦克风权限和托盘尺寸，并支持 Liquid Glass 图标（#2087、#2092、#2100、#2101、#2108、#2130）',
    new_0_6_31_10: '定时任务能更可靠地选择有效投递目标，频道设置也可安全清除已保存凭证，并明确反馈 Gateway 重启结果（#2106、#2109）',
    new_0_6_31_11: 'Studio MCP 自动注入默认跳过临时目录和 linked worktree 中的 launcher，除非显式允许，避免把不稳定路径写入持久 Profile 配置（#2121）',
    new_0_6_31_12: '版本管理现在可以迁移 Runtime 存储目录或恢复系统默认；下次重启时会复制校验 Runtime 和已下载的 Web UI 版本，并保留旧副本（#2134）',
    new_0_6_30_1: '本版本汇总 0.6.29 之后合并的 21 个 PR，涵盖工作流编排、MoA 会话、实时语音、持久记忆、Provider 稳定性、MCU 设置和 Windows 体验优化',
    new_0_6_30_2: '工作流编排 v2 新增按成功、失败和始终执行的条件路由、真正跳过、all/any 汇合、有界反馈循环、执行证据、截止时间与可移植导入（#2073）',
    new_0_6_30_3: '已启用的 MoA 组合现在可在创建或切换 Hermes 聊天会话时选择，并正确处理组合名称、默认项、上下文窗口与运行时行为（#2078）',
    new_0_6_30_4: '首屏通过按需加载 Markdown、Mermaid、Monaco、非当前语言和可选浮层，大幅减少初始 JavaScript（#2068）',
    new_0_6_30_5: '单聊新增全屏实时语音模式，支持实时转写、语音队列播放、工具活动和打断控制（#2063）',
    new_0_6_30_6: '桌面端与移动端实时语音更加稳定，可从静默恢复、避免录入助手语音、使用当前 STT 备用服务，并保持审批弹窗可见（#2064、#2067）',
    new_0_6_30_7: 'Ekko Agent 新增持久化的作用域记忆，在运行时上下文中提供当前 Provider 和模型，并更安全地处理生产环境记忆数据库（#2057、#2060、#2071）',
    new_0_6_30_8: '未配置 Provider 的 Profile 现在会显示设置引导，并可直接打开 Provider 表单（#2070）',
    new_0_6_30_9: 'Provider 模型目录已与 Hermes Agent 对齐，实时发现结果优先，过期备用缓存不再遮盖更新（#2051）',
    new_0_6_30_10: '自定义 Provider 别名在已加载的聊天会话中保持稳定，避免不必要的客户端重建和请求头丢失（#2054）',
    new_0_6_30_11: '会话模型切换现在显示阻塞式进度状态，切换对话时也会重放淡入动画且不重建草稿或附件（#2056、#2069）',
    new_0_6_30_12: 'Journey 图谱新增类别多选、不同的 Skill 和 Memory 节点形状、预览，以及更完善的键盘和触控操作（#2055）',
    new_0_6_30_13: 'Markdown 下载会保留文件扩展名，移动端转写新增明确的开始和停止控制，Scoped Codex 流式输出也不再重复最终助手消息（#2058、#2066）',
    new_0_6_30_14: 'MCU 设置与稳定性改进：显示设备码、自动选择麦克风、同步断开状态并限制 TLS 探测时间（#2049、#2059、#2062）',
    new_0_6_30_15: 'Windows 对话在 Git 或普通目录中捕获工作区变更时不再闪现 Git 黑窗（#2080）',
    new_0_6_29_1: '本版本汇总 0.6.28 之后合并的 14 个 PR，涵盖界面统一、MCU 音频与 v2 硬件、workspace diff、模型用量统计、Docker 更新和 MiMo 音色复刻',
    new_0_6_29_2: '统一页面标题、暗色卡片和圆角等视觉规范；版本预览会按语义版本倒序展示有效标签（#2014、#2015）',
    new_0_6_29_3: 'ESP32 产品介绍页完成响应式改版，网站版本选择器新增 Hermes Agent 0.18.2（#2020、#2042）',
    new_0_6_29_4: 'ESP32-C3 v1 上行语音改用 IMA-ADPCM，带宽降至约四分之一、录音上限增至 2 分钟；OLED 状态结束后会恢复显示局域网 IP（#2024、#2025）',
    new_0_6_29_5: 'Workspace diff 默认折叠并过滤零行变更，同时恢复聊天输入框的标准暗色背景（#2032）',
    new_0_6_29_6: '会话导出可兼容含异常百分号的文件名；Docker 用户点击升级时会看到镜像拉取与重建指引，而不会修改容器内 npm（#2026、#2033）',
    new_0_6_29_7: 'Bridge 工具结果仍会完整保存，但进入模型上下文时限制为 5,500 字符的头尾摘要，避免大结果持续放大上下文（#2036）',
    new_0_6_29_8: '用量分析统一记录 Hermes Agent、Claude Code、Codex 和 Ekko Agent 的模型调用，并新增 Agent 分布视图（#2039）',
    new_0_6_29_9: '新增独立的 ESP32-C3 v2 固件与硬件引脚配置，保持 v1 隔离；v2 默认音量 80%，采用 1.5 倍 PCM 增益和软限幅提升响度（#2044、#2045）',
    new_0_6_29_10: 'MiMo 音色复刻恢复 WAV/MP3 参考音频上传，并按当前 API 要求通过 audio.voice 发送参考音频（#2046）',
    new_0_6_28_1: '本版本汇总 0.6.27 之后合并的 PR：MCU 管理、群聊 workspace diff、Coding Agent 修复、Workflow 审批、workspace diff 过滤、定时任务模型选择和桌面端版本提示都已纳入',
    new_0_6_28_2: 'MCU 支持新增设备管理，global-agent 事件要求 API token 授权，ESP32-C3 固件已刷新，远程 relay 登录也更稳定',
    new_0_6_28_3: '群聊 workspace 变更会持久化为 workspace diff run，房间级 agent 活动在会话结束后仍可回看',
    new_0_6_28_4: 'Coding Agent 会继承 scoped external MCP server，workflow agent abort 路由更准确，并会尽力导出完成后的 Codex 与 Claude Code 原生会话',
    new_0_6_28_5: '会话体验修复了 workspace 文件抽屉、移除损坏的星标历史 embed，并记录 bridge 会话 ended_at 和 end_reason 元数据',
    new_0_6_28_6: 'Workflow 节点支持完成后的审批门禁，重复执行时的审批重跑状态也已修正',
    new_0_6_28_7: 'Workspace diff 会过滤 SQLite WAL/SHM sidecar，并跳过未变化文件继续扫描，确保新建的普通文件不会被隐藏',
    new_0_6_28_8: '定时任务支持选择并持久化 provider/model，同时不会把当前 Hermes cron CLI 不支持的模型参数传给 CLI',
    new_0_6_28_9: '桌面端版本管理按钮会在有更新时显示国际化的「有新版」提示，公开版本清单也加入 0.6.28',
    new_0_6_27_1: '本版本汇总 0.6.26 之后合并的 PR：桌面端启动兜底、Windows runtime、远程 MCU、群聊工作区、默认工作区收藏和空 diff 过滤都已纳入',
    new_0_6_27_2: '桌面端启动更稳：当 active Web UI 目录缺失或损坏时，会清理失效 Web UI 指针并回退到内置 Web UI，同时保留 runtime pin',
    new_0_6_27_3: 'Windows 桌面 runtime 改用可迁移的 hermes.cmd wrapper，避免旧 .exe trampoline 在 Web UI server 调用时失效',
    new_0_6_27_4: '远程 MCU 改走 Socket.IO /global-agent relay，ESP32-C3 登录、发现、远程机器识别、语音播放队列和 Wi-Fi 凭据保存更稳定，固件也已更新',
    new_0_6_27_5: '群聊支持创建和设置房间工作区，服务端校验 workspace，群聊 agent run 会继承该工作区；只读成员会隐藏 workspace、inviteCode 和管理入口',
    new_0_6_27_6: '默认工作区收藏星标移动到文件夹选择器的已选路径行右侧，并补齐各语言文案，工作区选择界面更自然',
    new_0_6_27_7: '工作区 diff 会跳过前后都是 0 字节且没有 patch 或行变化的空文件变更，避免出现 +0/-0 的无意义 diff 卡片',
  },
}
